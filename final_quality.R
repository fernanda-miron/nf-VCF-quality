...
#args[1] <- "./test/data/"
#args[2] <- "./test/data/SNP.png"
#args[3] <- "./test/data/ID.png"
#args[4] <- "./test/data/ID.tsv"
#args[5] <- 2
#args[6] <- 10
#args[7] <- "./test/data/SNP.tsv"
...
numeric_snp <- as.numeric(snp_cut)
numeric_id <- as.numeric(id_cut)
